...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "VERSION.yml", "lib/dm-sphinx-adapter", "lib/dm-sphinx-adapter/adapter.rb", "lib/dm-sphinx-adapter/attribute.rb", "lib/dm-sphinx-adapter/index.rb", "lib/dm-sphinx-adapter/query.rb", "lib/dm-sphinx-adapter/resource.rb", "lib/dm-sphinx-adapter/xmlpipe2.rb", "lib/dm-sphinx-adapter.rb", "lib/riddle", "lib/riddle/client", "lib/riddle/client/filter.rb", "lib/riddle/client/message.rb", "lib/riddle/client/response.rb", "lib/riddle/client.rb", "lib/riddle.rb", "test/files", "test/files/model.rb", "test/files/source.xml", "test/files/sphinx.conf", "test/files/test_xmlpipe2.xml", "test/files/tmp", "test/files/tmp/items.spa", "test/files/tmp/items.spd", "test/files/tmp/items.sph", "test/files/tmp/items.spi", "test/files/tmp/items.spl", "test/files/tmp/items.spm", "test/files/tmp/items.spp", "test/files/tmp/items_delta.spa", "test/files/tmp/items_delta.spd", "test/files/tmp/items_delta.sph", "test/files/tmp/items_delta.spi", "test/files/tmp/items_delta.spm", "test/files/tmp/items_delta.spp", "test/files/tmp/items_main.spa", "test/files/tmp/items_main.spd", "test/files/tmp/items_main.sph", "test/files/tmp/items_main.spi", "test/files/tmp/items_main.spm", "test/files/tmp/items_main.spp", "test/files/tmp/sphinx.log", "test/files/tmp/sphinx.pid", "test/files/tmp/sphinx.query.log", "test/helper.rb", "test/test_adapter.rb", "test/test_attribute.rb", "test/test_index.rb", "test/test_query.rb", "test/test_resource.rb", "test/test_xmlpipe2.rb"]
  s.has_rdoc = true
